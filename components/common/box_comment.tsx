				...
				<div className={styles.box_cm_body}>
					...
					<div className={styles.cm_list}>
						<div className={styles.box_cm_list}>
							...
							<div className={styles.cm_comment + ' ' + styles.cm_has_reply}>
								<div className={`${styles.cm_content} ${styles.cm_7294}`}>
									...
									<div className={`${styles.cm_box} ${styles.frame_cm_box}`}>
										...
										<div
											className={`${styles.cm_content} ${styles.cm_8397} ${styles.cm_reply_box}`}
										>
											...
											<div className={styles.cm_box}>
												<div className={styles.cm_cm_ct}>
													<p className={styles.cm_content_user}>Pa Link</p>
													<p className={styles.cm_nd}>acg</p>
												</div>
												<div className={styles.cm_cm_ev}>
										...
										>
											...
											<div className={styles.cm_box}>
												...
												<div className={styles.cm_cm_ev}>
													...
													<span
														className={`${styles.cm_list_like} ${styles.cm_count_like} count_ic`}
													/>
												</div>
											</div>
										</div>
							...
							<Content_Component
								dataCha={dataCha[0]}
								containerClassName={dataCha[0] ? styles.cm_has_reply : ''}
							>
								<Item_comment data={data[0]}></Item_comment>
								<Item_comment data={data[1]}></Item_comment>
								<Item_comment data={data[2]}>
									<span className={styles.line_reply1}></span>
								</Item_comment>
								<Input_reply />
							</Content_Component>
