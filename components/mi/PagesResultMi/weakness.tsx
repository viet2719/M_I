			...
			<div>
				<ul className={styles.item_yoursel}>
					<Image
						...
						height={50}
						alt=""
						src="https://hungha365.com/storageimage/MI-MBTI/public/images/mi/NA.svg"
					/>
				...
				<p style={{ fontSize: 17, fontWeight: 400 }}>
					...
					mong muốn được chia sẻ với bạn bè về các chủ đề liên quan tới lĩnh vực này. Bạn thường
					không ham thích tìm hiểu về thiên nhiên, dù là qua tủ sách hay các bộ phim về các hiện
					tượng và kiến thức liên quan đến thiên nhiên, bạn cũng hiếm khi để tâm và không muốn dành
					thời gian canh chừng để có thể chứng kiến những sự kiện thiên nhiên kỳ thú.
				</p>
			</div>
			<div>
				<ul className={styles.item_yoursel}>
					<Image
						...
						height={50}
						alt=""
						src="https://hungha365.com/storageimage/MI-MBTI/public/images/mi/MU.svg"
					/>
				...
				<p style={{ fontSize: 17, fontWeight: 400 }}>
					...
					nhạc một cách nhanh chóng. Sự thiếu hụt khả năng cảm thụ âm nhạc của bạn được nhận diện rõ
					ràng nhất khi bạn nghe các bản nhạc giao hưởng, hay những dòng nhạc với tiết tấu nhanh, mà
					...
					trưng của nơi đó, như là tiếng đường phố, xe cộ, tiếng chim hót hay tiếng lá cây xào xạc,
					etc. Bạn cũng không cần hay cảm thấy khó chịu khi có âm nhạc làm nền hoặc có người ngân
					nga trong các hoạt động thường ngày của mình, như khi ngồi làm việc, đi dạo, trò chuyện
					với bạn bè, etc. Với tố chất này, khi được ở trong hoàn cảnh thích hợp, bạn có thể thể
					hiện khả năng cảm nhận và điều hướng đám đông, bộc lộ khả năng lãnh đạo của mình một cách
					tự nhiên.
				</p>
			</div>
			<div>
				<ul className={styles.item_yoursel}>
					<Image
						...
						height={50}
						alt=""
						src="https://hungha365.com/storageimage/MI-MBTI/public/images/mi/LI.svg"
					/>
