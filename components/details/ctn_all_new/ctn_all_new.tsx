  ...
  return (
    ...
    <div className={`${styles.title_all}`}>
        ...
        <div className={`${styles.all_tag} ${styles.content_padding}`}>
            <div className={`${styles.select_tag}`}>
                ...
                <Link className={`${styles.t_tag}`} href="/tag1/viec-lam-tai-quan-hai-ba-trung-ha-noi-28">
                ...
                <Link className={`${styles.t_tag}`} href="/tag1/viec-lam-tai-huyen-thuong-tin-ha-noi-36">
                ...
                <Link className={`${styles.t_tag}`} href="/tag1/viec-lam-tai-huyen-thanh-tri-ha-noi-120">
            ...
            <img className={`${styles.show_tg}`}src="	https://timviec365.vn/images/detail/add_tag.svg" alt="địa điểm" />
        </div>
    </div>
    <div className={`${styles.title_all}`}>
        <div className={`${styles.option}`}>
        ...
        <div className={`${styles.all_tag} ${styles.content_padding}`}>
            ...
            <img className={`${styles.show_tg}`}src="	https://timviec365.vn/images/detail/add_tag.svg" alt="chức danh" />
        </div>
    </div>
    <div className={`${styles.title_all}`}>
        <div className={`${styles.option}`}>
        ...
        <div className={`${styles.all_tag} ${styles.content_padding}`}>
            <div className={`${styles.select_tag}`}>
                ...
                <Link className={`${styles.t_tag}`} href="/tim-viec-lam-ky-thuat-vien-dien-thoai-t14617.html">
                ...
                <Link className={`${styles.t_tag}`} href="/tag7/DS-viec-lam-tuyen-dung-ky-thuat-vien-1483">
                ...
                <Link className={`${styles.t_tag}`} href="/tag7/DS-viec-lam-tuyen-dung-ky-thuat-toa-nha-1852">
                ...
                <Link className={`${styles.t_tag}`} href="/tag7/DS-viec-lam-tuyen-dung-ky-thuat-vien-o-to-2016">
                ...
                <Link className={`${styles.t_tag}`} href="/tag7/DS-viec-lam-tuyen-dung-ky-thuat-nhuom-2288">
                    Việc làm kỹ thuật nhuộm
                </Link>
                <Link className={`${styles.t_tag}`} href="/tag7/DS-viec-lam-tuyen-dung-ky-thuat-vien-it-2290">
                    Việc làm kỹ thuật viên IT
                </Link>
                <Link className={`${styles.t_tag}`} href="/tag7/DS-viec-lam-tuyen-dung-ky-thuat-bao-hanh-2419">
                ...
                <Link className={`${styles.t_tag}`} href="/tag7/DS-viec-lam-tuyen-dung-pho-phong-ky-thuat-2995">
                ...
                <Link className={`${styles.t_tag}`} href="/tim-viec-lam-ky-thuat-vien-ep-nhua-t14619.html">
                    Việc làm kỹ thuật viên ép nhựa
                </Link>
                <Link className={`${styles.t_tag}`} href="/tim-viec-lam-ky-thuat-vien-tin-hoc-t14621.html">
                    Việc làm kỹ thuật viên tin học
                </Link>
            </div>
            <img className={`${styles.show_tg}`}src="	https://timviec365.vn/images/detail/add_tag.svg" alt="từ khóa liên quan" />
        </div>
    </div>
    <div className={`${styles.title_all}`}>
        <div className={`${styles.option}`}>
            ...
            <div className={`${styles.hd_tin}`}>
                <Link target="blank" href="/blog/chay-tiep-suc-la-gi-new16926.html">
                    <img
                        ...
                        data-src="/pictures/news/2023/08/17/wal1692269700.jpg"
    ...
    <div className={`${styles.title_all}`}>
        ...
        <div className={`${styles.timviec} ${styles.content_padding}`}>
            ...
            >
                <img src="https://timviec365.vn/images/detail/icon_ut.svg" alt="icon vl" /> Tìm việc làm Kỹ thuật
            </Link>
            <Link
                className={`${styles.city_dof } ${styles.btn_s_j}`}
            ...
            >
                <img src="https://timviec365.vn/images/detail/icon_ut.svg" alt="icon vl" /> Tìm việc làm Kỹ thuật ứng
                dụng
            </Link>
            <p className={`${styles.city_dof } ${styles.btn_s_j}`}>
                <img src="https://timviec365.vn/images/detail/icon_ut.svg" alt="icon vl" /> Tìm việc làm liên quan:
