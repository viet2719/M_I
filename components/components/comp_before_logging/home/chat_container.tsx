	...
	return (
		<div id={styles.liveChatContainer}>
			<div className={styles.widget + ' ' + styles.timviec365}>
				<button className={`${styles.talk_button} ${styles.connected}`} style={{ display: 'none' }}>
					Trực tuyến
				</button>
				<div className={styles.liveChatMain}>
					<div className={styles.liveChatHeader}>
						<div className={styles.liveChatHeaderButton}>
							<button id={styles.liveChatClose}>X</button>
						</div>
						<div className={`${styles.textCenter} ${styles.text}`}>
							...
							>
								Bạn tải CHAT365 <span className={styles.underLine}>tại đây</span> để nhận được sự hỗ
								trợ tốt nhất, <span className={styles.underLine}>tải ngay</span>
							</a>
						</div>
					</div>
